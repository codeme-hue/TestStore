		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="panel panel-primary">
					<div class="panel-heading">Checkout Keranjang</div>
					<div class="panel-body">
						<div class="row">
							<div class="col-md-2 col-xs-2"><b>Action</b></div>
							<div class="col-md-2 col-xs-2"><b>Gambar Produk</b></div>
							...
							<div class="col-md-2 col-xs-2"><b>Pembayaran <?php echo CURRENCY; ?></b></div>
						</div>
