								...
								while ($row=mysqli_fetch_array($query)) {
									?>
										<div class="row">
											...
											<div class="col-md-6">
												<table>
													<tr><td>Nama Produk</td><td><b><?php echo $row["product_title"]; ?></b> </td></tr>
													<tr><td>Harga Produk</td><td><b><?php echo  CURRENCY." ".$row["product_price"]; ?></b></td></tr>
													<tr><td>Jumlah</td><td><b><?php echo $row["qty"]; ?></b></td></tr>
													<tr><td>Transaksi Id</td><td><b><?php echo $row["trx_id"]; ?></b></td></tr>
												</table>
											</div>
										</div>
									<?php
